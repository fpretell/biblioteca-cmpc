...
exports.UsuariosModule = UsuariosModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([usuario_model_1.Usuario])],
        providers: [usuarios_service_1.UsuariosService],
        controllers: [usuarios_controller_1.UsuariosController],
        exports: [usuarios_service_1.UsuariosService], // para que pueda usarse en otros módulos (ej: AuthModule)
    })
], UsuariosModule);
